...
#define GRSTAPS_GRSTAPS_BESTFIRSTCPP
...
namespace grstaps {
    ...
    template<class Data>
    BestFirstSearch<Data>::BestFirstSearch(Graph<Data> &graph, nodePtr<Data> &initPtr) : SearchBase<Data>(graph, initPtr) {
    ...
    template<class Data>
    bool BestFirstSearch<Data>::updateCurrent()  {
