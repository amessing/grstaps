...
{
    template <class Data>
    UniformCostSearch<Data>::UniformCostSearch(Graph<Data>& graph, nodePtr<Data> initPtr)
                                         ...
                                         SearchResultPackager<Data>* results)
    {
        ...
        NodeExpander<Data>& expandGraph =
            *expander;  // Functor that takes a node and a graph and expands that node to add children
