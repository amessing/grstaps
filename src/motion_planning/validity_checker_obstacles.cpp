 ...
 */
#include "grstaps/motion_planning/validity_checker_obstacles.hpp"
...
namespace grstaps
{
    ...
    ValidityCheckerObstacles::ValidityCheckerObstacles(const std::vector<b2PolygonShape>& obstacles,
                                     const ob::SpaceInformationPtr& space_information)
        : ob::StateValidityChecker(space_information)
        , m_obstacles(obstacles)
    {}

    bool ValidityCheckerObstacles::isValid(const ob::State* state) const
    {
