 ...
 */
#ifndef GRSTAPS_VALIDITY_CHECKER_OBSTACLES_HPP
#define GRSTAPS_VALIDITY_CHECKER_OBSTACLES_HPP
...
namespace grstaps
{
     ...
     */
    class ValidityCheckerObstacles : public ompl::base::StateValidityChecker
    {
    public:
        /**
         * Constructor
         */
        ValidityCheckerObstacles(const std::vector<b2PolygonShape>& obstacles,
